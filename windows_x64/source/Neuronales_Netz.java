/* autogenerated by Processing revision 1279 on 2022-02-06 */
...
Tasks task;
 ...
 public void taskSetup(Tasks task) {
...
class Functions {
  ...
  //holdingClass ist das Object in dem das gesuchte Field ist
   ...
   public boolean isColor(int c, int amount) {

    int red = PApplet.parseInt(red(c));
    int green = PApplet.parseInt(green(c));
    int blue = PApplet.parseInt(blue(c));
